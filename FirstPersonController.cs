...

{
    ...
    //public AudioClip[] myAudioClipArray;
    public AudioClip footstep1, footstep2, footstep3, footstep4, footstep5, footstep6, footstep7, footstep8, footstep9, footstep10;
    ...
    private void HeadBob()
    {
        ...
        if (isWalking)
        {
            ...
            if ((joint.localPosition.y <= .71f) && isPlaying == false)
            {
                //Play my audio clip
    ...
    /*public class MyRandomArray1 : MonoBehaviour
    {
        ...
        float myPitch = Random.Range(.8f, .99f);
        ...
        if (rand == 4)
        {
            audioSource.clip = footstep5;

        }
        if (rand == 5)
        {
            audioSource.clip = footstep6;

        }
        if (rand == 6)
        {
            audioSource.clip = footstep7;

        }
        if (rand == 7)
        {
            audioSource.clip = footstep8;

        }
        if (rand == 8)
        {
            audioSource.clip = footstep9;

        }

        else if (rand == 9)
        {
            audioSource.clip = footstep10;
        ...
        IEnumerator MyWait()
        {
            yield return new WaitForSeconds(1 / bobSpeed);
            isPlaying = false;
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.footstep1 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep1, typeof(AudioClip), true);
        fpc.footstep2 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep2, typeof(AudioClip), true);
        fpc.footstep3 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep3, typeof(AudioClip), true);
        fpc.footstep4 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep4, typeof(AudioClip), true);
        fpc.footstep5 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep5, typeof(AudioClip), true);
        fpc.footstep6 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep6, typeof(AudioClip), true);
        fpc.footstep7 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep7, typeof(AudioClip), true);
        fpc.footstep8 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep8, typeof(AudioClip), true);
        fpc.footstep9 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep9, typeof(AudioClip), true);
        fpc.footstep10 = (AudioClip)EditorGUILayout.ObjectField(new GUIContent("AuidioClip", "Footstep Clips"), fpc.footstep10, typeof(AudioClip), true);
        #endregion
